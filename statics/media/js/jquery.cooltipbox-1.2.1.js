...
(function($) {
    ...
    $.fn.cooltipbox = function(settings) {
        ...
        this.each(function() {
            ...
            if(settings.useTitle)
                $content = $('<div class="cool-tip-box-content">' + $this.attr('title') + '</div>');
            else
                $content = $('<div class="cool-tip-box-content">' + settings.text + '</div>');

            var $wrapper = $content.wrap('<div class="cool-tip-box">').parent()
                ,$arrow = '';
